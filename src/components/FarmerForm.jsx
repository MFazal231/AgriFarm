    ...
    <div className="max-w-2xl mx-auto p-6">
      ...
      >
        ...
        {submittedData && (
          ...
          >
            <h3 className="text-xl font-bold text-white mb-4">Submitted Details</h3>
            <div className="space-y-2 text-white">
              <p><span className="font-semibold">Farmer:</span> {submittedData.name}</p>
              <p><span className="font-semibold">Crop:</span> {submittedData.cropName}</p>
