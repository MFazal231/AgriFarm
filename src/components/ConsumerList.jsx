...
const ConsumerList = () => {
  ...
  const { availableCrops, purchaseCrop } = useAgriContext();
  ...
  const openPurchaseModal = (crop) => {
    if (crop.quantity <= 0) {
      alert('This crop is out of stock!');
      return;
    }
    ...
    <div className="max-w-6xl mx-auto p-6">
      ...
      >
        ...
        {purchaseSuccess && (
          ...
          >
            ✓ Purchase successful! Check your purchased crops.
          </motion.div>
        )}
                  ...
                  >
                    ...
                    <td className="py-4 px-4">
                      ...
                      >
                        ...
                        {crop.quantity <= 0 ? 'Out of Stock' : 'Buy'}
                      </button>
                    </td>
                  </motion.tr>
                ))
            ...
            >
              ...
              <div className="mb-6 space-y-3">
                ...
                <div className="flex justify-between text-white">
                  ...
                  <span className="font-bold text-agri-green-light">${selectedCrop.price}</span>
                </div>
              </div>
              ...
              <div className="mb-6 p-4 bg-agri-green/20 border border-agri-green/30 rounded-lg">
                <div className="flex justify-between items-center text-white">
                  ...
                  <span className="text-2xl font-bold text-agri-green-light">
                    ${(selectedCrop.price * purchaseQuantity).toFixed(2)}
                  </span>
                </div>
              </div>
